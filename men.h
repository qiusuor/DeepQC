...
//    st_pro[pos[0]].scale=st_num;
//    st_pro[pos[0]].high=1;
//    for (int k = 1; k < st_num; ++k) {
//        st_pro[pos[k]].low=k;
//        st_pro[pos[k]].high=k+1;
//        st_pro[pos[k]].scale=st_num;
//    }
    delete [] pos;
...
//				content[idx_file*num_max_seq_len + i] = line[i];
...
#ifdef debug
			cout<<characters[content[i*num_reads_per_batch * num_max_seq_len + col_index]];
#endif
//			data[0][i][0] = content[i*num_reads_per_batch * num_max_seq_len + col_index];
...
//        cout<<start_pos[6649]<<endl;
//        cout<<start_pos[6650]<<endl;
//        cout<<start_pos[6661]<<endl;
...
//		cout<<ptr<<endl;
        ...
        *ptr++=num_rows;
//		cout<<ptr<<endl;
//        cout<<out_size[6649]<<endl;
//        cout<<out_size[6650]<<endl;
//        cout<<out_size[6651]<<endl;
//        cout<<mems[6649].true_size<<endl;
//        cout<<mems[6650].true_size<<endl;
//        cout<<mems[6651].true_size<<endl;
